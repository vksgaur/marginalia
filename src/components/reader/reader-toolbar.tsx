...
export function ReaderToolbar({
  ...
  return (
    <div className="flex items-center gap-2 px-4 py-2 border-b border-border/50 bg-inherit">
      {/* Back */}
      ...
      {/* Title */}
      <span className="flex-1 truncate text-sm font-medium mx-2">{title}</span>

      {/* Highlight color selector */}
      <div className="flex items-center gap-1 border border-border/50 rounded-md px-2 py-1">
